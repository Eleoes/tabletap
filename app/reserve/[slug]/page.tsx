                    ...
                    {/* HEADER */}
                        <div>
                            ...
                            <div className="mt-5 flex">
                                <img src="https://resizer.otstatic.com/v2/photos/legacy/3/47158974.jpg" alt="" className="w-32 h-18 rounded" />
                                <div className="ml-4">
                                    <h1 className="text-3xl font-bold">Daughter Thai Kitchen</h1>
                        ...
                        <div className="mt-10 flex flex-wrap justify-between w-[660px]">
                            ...
                            <p className="text-sm">
                            By clicking “Complete reservation” you agree to the TableTap Terms of Use and Privacy Policy. Standard text message rates may apply. You may opt out of receiving text messages at any time.
                            </p>
                        </div>
                    </div>
                </div>
